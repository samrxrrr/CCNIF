...
source("scripts/modules/production/02_enrichment_pipeline.R")
...
###############################################################################
cat("[04/15] Enrichment Pipeline\n")

tryCatch({

build_enrichment_pipeline(driver)

}, error=function(e){

cat("Skipping Enrichment Pipeline:",e$message,"\n")

})

###############################################################################
cat("[05/16] Functional Evidence\n")
tryCatch({
